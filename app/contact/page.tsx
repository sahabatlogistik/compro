...
import { ArrowRight, Phone, Mail, MapPin, Clock, Send, MessageCircle, Building, User } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-gray-200 bg-white" data-aos="fade-up" data-aos-delay={index * 100}>
                <CardContent className="p-6 text-center space-y-4">
                  <div className={`w-16 h-16 bg-${contact.color}/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-${contact.color} transition-colors`}>
                    <contact.icon className={`h-8 w-8 text-${contact.color} group-hover:text-white transition-colors`} />
                  </div>
                  <h3 className="text-xl font-semibold text-msl-navy">{contact.title}</h3>
                  <p className="font-medium text-gray-900">{contact.value}</p>
                  <p className="text-sm text-gray-600">{contact.description}</p>
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className={`border-${contact.color} text-${contact.color} hover:bg-${contact.color} hover:text-white w-full`}
                    asChild
                  >
            ...
            <div data-aos="fade-right">
              <div className="space-y-6 mb-8">
                ...
                <p className="text-lg text-gray-600">
                  Isi formulir di bawah ini dan tim kami akan menghubungi Anda dalam 24 jam untuk memberikan solusi terbaik.
                </p>
              </div>
            ...
            <div data-aos="fade-left">
              <div className="space-y-8">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="pt-3 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        <strong>Emergency Service:</strong> 24/7 untuk layanan urgent
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-gray-200">
                  <CardHeader>
                    <CardTitle className="text-xl text-msl-navy">Mengapa Memilih MSL?</CardTitle>
                  </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card className="border-gray-200 text-center">
                    <CardContent className="p-6">
                      <div className="text-2xl font-bold text-msl-navy">{siteConfig.company.clients}</div>
                      <div className="text-sm text-gray-600">Klien Terlayani</div>
                    </CardContent>
                  </Card>
                  <Card className="border-gray-200 text-center">
                    <CardContent className="p-6">
                      <div className="text-2xl font-bold text-msl-orange">{siteConfig.company.satisfaction}</div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12" data-aos="fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Kantor pusat kami berlokasi strategis di Batam untuk melayani kebutuhan logistik Anda
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8" data-aos="fade-up">
            ...
            <div className="space-y-6">
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-lg text-msl-navy">Alamat Lengkap</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
              ...
              <Card className="border-gray-200">
                <CardHeader>
                  <CardTitle className="text-lg text-msl-navy">Akses Transportasi</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="space-y-2">
                    <p className="text-sm text-gray-600">
              ...
              <Button className="w-full bg-msl-orange hover:bg-msl-orange/90 text-white" asChild>
