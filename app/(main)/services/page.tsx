        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
              Dari transportasi hingga supply chain management, kami menyediakan
              layanan logistik end-to-end yang disesuaikan dengan kebutuhan
              bisnis Anda.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pengalaman {siteConfig.company.experience} tahun melayani{" "}
              {siteConfig.company.clients} klien dengan tingkat kepuasan{" "}
            ...
            {[
              {
                ...
                description:
                  "Sistem tracking real-time dan platform digital untuk transparansi penuh",
                icon: "🚀",
                metric: "99.9% Uptime",
              },
              {
                title: "Jaringan Luas",
                description:
                  "Coverage area mencakup seluruh Indonesia dengan partner terpercaya",
                icon: "🌐",
                metric: "34 Provinsi",
              },
              {
                ...
                description:
                  "SDM berpengalaman dan tersertifikasi dengan komitmen tinggi",
                icon: "👥",
                metric: "500+ Karyawan",
              },
              {
                ...
                description:
                  "Solusi cost-effective dengan value terbaik tanpa mengorbankan kualitas",
                icon: "💰",
                metric: "Hemat 30%",
              },
            ].map((item, index) => (
