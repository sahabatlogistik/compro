            ...
            <div className="space-y-8" data-aos="fade-right">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Kami menyediakan layanan logistik komprehensif dengan
                  teknologi modern, jaringan distribusi luas, dan komitmen
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dari transportasi hingga pergudangan, kami menyediakan solusi
              logistik end-to-end yang disesuaikan dengan kebutuhan bisnis Anda.
            </p>
          </div>
