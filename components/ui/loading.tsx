    ...
    >
      <div className="flex flex-col items-center space-y-4">
        ...
        <div className="text-center">
          <h3 className="text-lg font-semibold text-msl-navy mb-2">
            PT. Mitra Sahabat Logistik
          </h3>
          <div className="flex items-center space-x-1">
            <div className="w-2 h-2 bg-msl-orange rounded-full animate-bounce"></div>
            <div
              className="w-2 h-2 bg-msl-orange rounded-full animate-bounce"
  ...
  return (
    <div className="fixed inset-0 z-50 bg-white flex flex-col items-center justify-center">
      <div className="flex flex-col items-center space-y-6 max-w-md mx-auto px-4">
        ...
        {/* Loading Text */}
        <div className="text-center">
          <h3 className="text-xl font-bold text-msl-navy mb-2">
            PT. Mitra Sahabat Logistik
          </h3>
